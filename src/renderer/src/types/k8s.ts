...
export type AccessSubject = Shared.AccessSubject
export type AccessSubjectKind = Shared.AccessSubjectKind
export type K8sAccessReviewRequest = Shared.AccessReviewRequest
export type K8sAccessReviewResult = Shared.AccessReviewResult
export type K8sAccessRule = Shared.AccessRule
export type K8sEffectiveAccessRule = Shared.EffectiveAccessRule
export type K8sSubjectBinding = Shared.SubjectBinding
export type K8sSubjectPermissions = Shared.SubjectPermissions
export type K8sSelfRules = Shared.SelfRulesResult
export type K8sRoleSubjectBinding = Shared.RoleSubjectBinding
...
export type K8sWebhookRule = Shared.WebhookRule
export type K8sWebhookClientConfig = Shared.WebhookClientConfigInfo
export type K8sWebhookSelector = Shared.WebhookSelectorInfo
export type K8sWebhookMatchCondition = Shared.WebhookMatchCondition
export type K8sWebhook = Shared.WebhookInfo
export type K8sWebhookConfigurationType = Shared.WebhookConfigurationType
export type K8sWebhookConfigurationSummary = Shared.WebhookConfigurationSummary
export type K8sWebhookConfiguration = Shared.WebhookConfigurationInfo
...
export type K8sApiResource = Shared.ApiResourceInfo
export type K8sApiGroupVersionError = Shared.ApiGroupVersionError
export type K8sApiResourceCatalog = Shared.ApiResourceCatalog
