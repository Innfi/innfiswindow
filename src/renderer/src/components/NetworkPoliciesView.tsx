...
function DetailPanel({
  ...
  return (
    ...
    >
      {/* Spec */}
      <CollapsibleSection id="networkPolicy.spec" title="Spec">
      ...
      {labelEntries.length > 0 && (
        <CollapsibleSection id="networkPolicy.labels" title="Labels">
      ...
      {annotationEntries.length > 0 && (
        <CollapsibleSection id="networkPolicy.annotations" title="Annotations">
      ...
      <ResourceEventsSection
        ...
        kind="NetworkPolicy"
        search={sl}
        collapsibleId="networkPolicy.events"
      />
    </DetailPanelLayout>
  )
}
...
export function NetworkPoliciesView(): JSX.Element {
  return (
    <ResourceListView<K8sNetworkPolicySummary, K8sNetworkPolicy>
      ...
      list={(ctx, ns, sel) =>
        window.api.k8s.listNetworkPolicies({
          contextName: ctx,
          namespace: ns,
          labelSelector: sel,
        })
