  ...
  forbidden: [
    {
      name: 'no-circular',
      severity: 'error',
      comment: 'Circular imports break module init order and defeat tree shaking.',
      from: {},
      to: { circular: true }
    },
    {
    ...
    },
    {
      ...
      severity: 'error',
      comment: 'k8s API calls belong in the main process only — renderer talks IPC.',
    ...
    },
    {
      ...
      severity: 'error',
      comment: 'Renderer must not import electron directly; use the preload bridge.',
      from: { path: '^src/renderer' },
      to: { path: '^electron$' }
    },
    {
